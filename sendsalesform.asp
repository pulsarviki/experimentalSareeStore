...
<table border="0" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="780" id="AutoNumber1" bgcolor="#FFFFE1">
  <tr>
    <td width="50%" style="border-bottom: 1px solid #FF9933" valign="baseline">
        <p align="right">
        <img border="0" src="images/ksiclogo.gif" align="left"><font size="4" color="#FF0000">&nbsp;&nbsp;
        </font></td>
    <td style="border-bottom: 1px solid #FF9933" align="right" >
  ...
  <tr>
    ...
    <table border="0" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="726" id="AutoNumber2" height="326">
      <tr>
        <td valign="top" width="217" height="323">
            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="97%" id="AutoNumber6" height="220">
              <tr>
        ...
        <td width="502" align="center" valign="top" height="323">
       <!--
...
&nbsp;</p>
         <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="90%" id="AutoNumber7">
           <tr>
             ...
             <td width="80%"><font face="Arial" size="4">Your Message has been
             <br>
             Sent 
