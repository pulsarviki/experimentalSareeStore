...
<table border="0" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="780" id="AutoNumber1" bgcolor="#FFFFE1">
  <tr>
    <td width="50%" style="border-bottom: 1px solid #FF9933" valign="baseline" height="66">
        <p align="right">
        <img border="0" src="images/ksiclogo.gif" align="left"><font size="4" color="#FF0000">&nbsp;&nbsp;
        </font></td>
    <td style="border-bottom: 1px solid #FF9933" align="right" height="66" >
  ...
  <tr>
    <td width="100%" height="320" colspan="2">
    <table border="0" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="726" id="AutoNumber2" height="100%">
      <tr>
        <td valign="top" width="217">
            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="97%" id="AutoNumber6" height="229">
              <tr>
                <td width="100%" height="229" align="center">
                <img border="0" src="images/post.bmp" width="183" height="124"></td>
              </tr>
            </table>
            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="92%" id="AutoNumber5">
             
            </table>
            <table cellpadding="5" cellspacing="5" width="100%" style="border-collapse: collapse" bordercolor="#111111">
              <tr>
       ...
       <!--
       <img border="0" src="images/group.gif" width="500" height="450"> -->
...
&nbsp;</p>
         <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="90%" id="AutoNumber7">
           <tr>
             ...
             <td width="80%"><font face="Arial" size="4">Your Message has been<br>
             Sent 
           ...
           <tr>
             ...
             <p align="center"><font face="Arial">Have a Nice Day</font></td>
           </tr>
         </table>
         </center>
       </div>
...
&nbsp;</font></td>
  ...
  <tr>
    ...
    <table cellspacing="1" style="border-collapse: collapse; border-top: 1px solid #FF9933" width="100%" id="AutoNumber3">
      <tr>
        <td width="50%"><font size="2" face="Arial">©2003 Karnataka Silk Industries Corporation</font></td>
        <td width="50%">
